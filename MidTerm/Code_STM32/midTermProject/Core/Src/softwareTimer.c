...
int timer3_counter_for_time_out = 0;
int timer3_flag_for_time_out = 0;
...
void setTimer3ForTimeOut(int duration){
	timer3_counter_for_time_out = duration;
	timer3_flag_for_time_out = 0;
}
...
void timerRun(){
	...
	if (timer3_counter_for_time_out > 0){
		timer3_counter_for_time_out --;
			if(timer3_counter_for_time_out <= 0){
				timer3_flag_for_time_out = 1;
			}
		}
}
